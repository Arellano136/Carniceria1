...
function EditCutModal({ showModalEdit, handleCerrarModalEdit, selectedCut, handleImageUpload }) {
  const formik = useFormik({
    ...
    validationSchema: yup.object({
      ...
      quantity: yup.number().min(0, 'La cantidad debe ser mayor o igual a 0').required('Campo obligatorio'),
      price: yup.number().min(0, 'El precio debe ser mayor o igual a 0').required('Campo obligatorio'),
    }),
    onSubmit: values => {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          // Aquí puedes ejecutar la función de guardado
          // handleSave(values);
              ...
              <div className="p-4 md:p-5 ">
                ...
                <form onSubmit={formik.handleSubmit}>
                  <div>
                    ...
                    />
                    {formik.touched.cut && formik.errors.cut ? <div className="text-red-500">{formik.errors.cut}</div> : null}
                  </div>
