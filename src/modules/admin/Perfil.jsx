...
function Perfil() {
  ...
  const updateFormik = useFormik({
    ...
    onSubmit: (values) => {
      // Aquí puedes realizar alguna acción con los valores, como enviarlos al servidor
      // También puedes mostrar una alerta de confirmación antes de enviar los datos
      Swal.fire({
          title: '¿Estás seguro?',
        ...
        <div className='grid grid-cols-2 gap-4 px-5 pt-5'>
          <div>
            ...
            {updateFormik.touched.email && updateFormik.errors.email ? (
              <div className="text-red-500 text-sm">{updateFormik.errors.email}</div>
            ) : null}
          </div>
          <div>
            ...
            {updateFormik.touched.phone && updateFormik.errors.phone ? (
              <div className="text-red-500 text-sm">{updateFormik.errors.phone}</div>
            ) : null}
          </div>
        </div>
        <div className='grid grid-cols-2 gap-4 px-5 pt-5'>
      ...
      <div>
        ...
        <div>
          ...
          {changePasswordFormik.touched.newPassword && changePasswordFormik.errors.newPassword ? (
            <div className="text-red-500 text-sm">{changePasswordFormik.errors.newPassword}</div>
          ) : null}
        </div>
        <div>
          ...
          {changePasswordFormik.touched.confirmPassword && changePasswordFormik.errors.confirmPassword ? (
            <div className="text-red-500 text-sm">{changePasswordFormik.errors.confirmPassword}</div>
          ) : null}
        </div>
        <div>
          ...
          {changePasswordFormik.touched.currentPassword && changePasswordFormik.errors.currentPassword ? (
            <div className="text-red-500 text-sm">{changePasswordFormik.errors.currentPassword}</div>
          ) : null}
        </div>
      </div>
          <div className="grid justify-end m-5">
